...
See **[apps/daily-dairy/clinical_diary/README.md](apps/daily-dairy/clinical_diary/README.md)** for complete documentation on:
...
### Deployment Guide
See `apps/daily-dairy/clinical_diary/README.md` for Firebase deployment details.
