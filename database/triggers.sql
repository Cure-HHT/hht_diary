...
COMMENT ON FUNCTION log_break_glass_access() IS 'Logs all break-glass access to sensitive tables for compliance monitoring (REQ-p10007, REQ-d00025)';
...
COMMENT ON FUNCTION complete_export_log() IS 'Validates export completion and logs activity (REQ-p10005, REQ-d00024)';
