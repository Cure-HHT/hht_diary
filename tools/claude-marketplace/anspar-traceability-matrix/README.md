...
chmod +x tools/claude-marketplace/anspar-traceability-matrix/hooks/pre-commit-traceability-matrix
```
...
- **Generation Script**: `tools/requirements/generate_traceability.py`
- **Requirement Validation**: `tools/claude-marketplace/anspar-requirement-validation`
...
- **Plugin Path**: `tools/claude-marketplace/anspar-traceability-matrix`
