...
async function main() {
    ...
    try {
        ...
        console.log(`   2. Claim for work: tools/claude-marketplace/anspar-workflow/scripts/claim-ticket.sh ${ticket.identifier}`);
        ...
        if (error.message.includes('team')) {
            ...
            console.error('  node tools/claude-marketplace/anspar-linear-integration/scripts/test-config.js');
        }
