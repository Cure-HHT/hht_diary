...
chmod +x tools/claude-marketplace/anspar-requirement-validation/hooks/pre-commit-requirement-validation
```
...
- **Validation Script**: `tools/requirements/validate_requirements.py`
- **Traceability Matrix**: `tools/claude-marketplace/anspar-traceability-matrix`
...
- **Plugin Path**: `tools/claude-marketplace/anspar-requirement-validation`
