...
cd diary/tools/claude-marketplace/anspar-spec-compliance
...
chmod +x tools/claude-marketplace/anspar-spec-compliance/hooks/pre-commit-spec-compliance
```
...
- name: Validate Spec Compliance
  run: |
    chmod +x tools/claude-marketplace/anspar-spec-compliance/scripts/validate-spec-compliance.sh
    ./tools/claude-marketplace/anspar-spec-compliance/scripts/validate-spec-compliance.sh
```
...
- **Plugin Path**: `tools/claude-marketplace/anspar-spec-compliance`
