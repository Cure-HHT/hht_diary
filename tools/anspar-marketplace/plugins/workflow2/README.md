...
chmod +x tools/anspar-marketplace/plugins/workflow2/scripts/*.sh
chmod +x tools/anspar-marketplace/plugins/workflow2/hooks/*
```
...
WORKFLOW_PRECOMMIT_HOOK="tools/anspar-marketplace/plugins/workflow2/hooks/pre-commit"
...
# Workflow Enforcement (Plugin)
WORKFLOW_COMMITMSG_HOOK="tools/anspar-marketplace/plugins/workflow2/hooks/commit-msg"
...
WORKFLOW_POSTCOMMIT_HOOK="tools/anspar-marketplace/plugins/workflow2/hooks/post-commit"
...
./tools/anspar-marketplace/plugins/workflow2/scripts/claim-ticket.sh CUR-262
# Work on feature A...

# Worktree 2: Feature B (different ticket)
cd ~/diary-worktrees/feature-b
./tools/anspar-marketplace/plugins/workflow2/scripts/claim-ticket.sh CUR-263
# Work on feature B...
...
- **Plugin Path**: `tools/anspar-marketplace/plugins/workflow2`
