...
All notable changes to the Workflow2 plugin will be documented in this file.
...
### Added
- Initial release of workflow2 - next-generation workflow enforcement plugin
- Enhanced from anspar-workflow with improved architecture and features
