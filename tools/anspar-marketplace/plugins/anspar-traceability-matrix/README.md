...
TRACEABILITY_HOOK="tools/anspar-marketplace/plugins/anspar-traceability-matrix/hooks/pre-commit-traceability-matrix"
...
chmod +x tools/anspar-marketplace/plugins/anspar-traceability-matrix/hooks/pre-commit-traceability-matrix
```
...
- **anspar-requirement-validation**: Validates requirements before matrix generation
- **anspar-spec-compliance**: Enforces spec/ directory compliance
- **anspar-linear-integration**: Creates Linear tickets from requirements
...
- **Generation Script**: `tools/requirements/generate_traceability.py`
- **Requirement Validation**: `tools/anspar-marketplace/plugins/anspar-requirement-validation`
...
- **Plugin Path**: `tools/anspar-marketplace/plugins/anspar-traceability-matrix`
