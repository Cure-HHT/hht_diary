...
const { isValidCommandName } = require('../utils/validation');
const { toKebabCase } = require('../utils/string-helpers');
const { escapePromptForMarkdown } = require('../utils/escape-helpers');
