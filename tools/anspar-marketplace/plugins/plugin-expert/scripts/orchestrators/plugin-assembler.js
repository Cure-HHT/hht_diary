...
const { safeWrite } = require('../utils/file-ops');
const { safeJSONStringify } = require('../utils/escape-helpers');

// Layer 2 builders
const { buildPluginMetadata, buildMarketplaceMetadata } = require('../generators/metadata-builder');
const { buildSkillPrompt, buildAgentPrompt, buildCommandPrompt } = require('../generators/prompt-builder');
const { buildCommands, buildSingleCommand } = require('../generators/command-builder');
const { buildHooksConfig } = require('../generators/hook-builder');
const { buildDocumentation } = require('../generators/docs-builder');
const { buildTestSuite, createTestFiles } = require('../generators/test-builder');
const { createPluginStructure } = require('../generators/organization');
