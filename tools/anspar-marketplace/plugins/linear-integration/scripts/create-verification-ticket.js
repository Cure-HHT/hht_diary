 ...
 *   node create-verification-ticket.js '{"req_id":"d00027","old_hash":"abc123","new_hash":"def456","title":"...","file":"..."}'
 *
 *   # From file:
 *   node create-verification-ticket.js --input changed-req.json
 *
 *   # Interactive:
 *   node create-verification-ticket.js --req-id d00027 --old-hash abc123 --new-hash def456
 *
 * Output:
...
Usage:
  ...
  node create-verification-ticket.js '{"req_id":"d00027",...}'
...
Examples:
  ...
  echo '{"req_id":"d00027",...}' | node create-verification-ticket.js

  # From file:
  node create-verification-ticket.js --input /tmp/changed-req.json
...
async function main() {
    ...
    try {
        ...
        if (error.message.includes('team')) {
            ...
            console.error('  node tools/anspar-marketplace/plugins/linear-integration/scripts/test-config.js');
        }
