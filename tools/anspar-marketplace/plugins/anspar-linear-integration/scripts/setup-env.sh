...
#
# Usage:
#   source tools/anspar-marketplace/plugins/anspar-linear-integration/scripts/setup-env.sh
#
# Or to just get the team ID:
#   bash tools/anspar-marketplace/plugins/anspar-linear-integration/scripts/setup-env.sh
#
