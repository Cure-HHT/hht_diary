...
node tools/anspar-marketplace/plugins/anspar-linear-integration/scripts/fetch-tickets.js
...
node tools/anspar-marketplace/plugins/anspar-linear-integration/scripts/update-ticket-status.js --token=$LINEAR_API_TOKEN --ticket-id=CUR-127 --status=in-progress

# After completing implementation, Claude marks it done
node tools/anspar-marketplace/plugins/anspar-linear-integration/scripts/update-ticket-status.js --token=$LINEAR_API_TOKEN --ticket-id=CUR-127 --status=done
```
