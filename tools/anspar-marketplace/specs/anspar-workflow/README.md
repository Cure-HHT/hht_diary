...
chmod +x tools/claude-marketplace/anspar-workflow/scripts/*.sh
chmod +x tools/claude-marketplace/anspar-workflow/hooks/*
```
...
WORKFLOW_POSTCOMMIT_HOOK="tools/claude-marketplace/anspar-workflow/hooks/post-commit"
...
./tools/claude-marketplace/anspar-workflow/scripts/claim-ticket.sh CUR-262
# Work on feature A...

# Worktree 2: Feature B (different ticket)
cd ~/diary-worktrees/feature-b
./tools/claude-marketplace/anspar-workflow/scripts/claim-ticket.sh CUR-263
# Work on feature B...
...
- **Plugin Path**: `tools/claude-marketplace/anspar-workflow`
