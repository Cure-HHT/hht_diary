...
#
# DevOps Image for Clinical Diary
# Minimal image for Terraform + GCP cloud operations.
# Replaces ops.Dockerfile. Same image used for devops-main and devops-sponsor
# services, differentiated by env vars and volume mounts.
#
...
LABEL description="DevOps environment: Terraform + GCP cloud operations"
LABEL org.opencontainers.image.source="https://github.com/cure-hht/clinical-diary"
LABEL org.opencontainers.image.licenses="MIT"
LABEL com.clinical-diary.role="devops"
...
# Set up workspace
# ============================================================
RUN mkdir -p /workspace/terraform /workspace/src && \
...
HEALTHCHECK --interval=30s --timeout=10s --retries=3 --start-period=30s \
    CMD terraform --version && gcloud --version

CMD ["/bin/bash", "-l"]

LABEL com.clinical-diary.version="2.0.0"
LABEL com.clinical-diary.tools="terraform,gcloud,doppler,psql,cloud-sql-proxy"
