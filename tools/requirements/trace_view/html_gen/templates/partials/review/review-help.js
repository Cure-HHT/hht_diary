...
(function(RS) {
    ...
    function shouldShowOnboarding() {
        ...
        const storageKey = settings.storageKey || 'spec-review-onboarding-complete';
    ...
    function renderOnboardingCompletion() {
        ...
        overlay.querySelector('.rs-onboarding-docs')?.addEventListener('click', () => {
            window.open('docs/spec-review-user-guide.md', '_blank');
            completeOnboarding();
        });
    }
    ...
    function showHelpPanel() {
        ...
        panelEl.innerHTML = `
            <div class="rs-help-panel-header">
                <h3>${panel.title}</h3>
                <button class="rs-btn rs-btn-sm rs-help-close">×</button>
            </div>
        ...
        container.innerHTML = `
            ...
            <div class="rs-help-menu-dropdown" id="rs-help-menu-dropdown">
                ...
                <div class="rs-help-menu-section">
                    ...
                    <a href="docs/spec-review-quick-start.md" target="_blank" class="rs-help-menu-item">
                        <span class="rs-menu-icon">⚡</span>
                        <span class="rs-menu-label">Quick Start</span>
                    </a>
                    <a href="docs/spec-review-user-guide.md" target="_blank" class="rs-help-menu-item">
                        <span class="rs-menu-icon">📚</span>
