...
(function(RS) {
    ...
    RS.fetchGitSyncStatus = fetchGitSyncStatus;
    ...
    async function gitPush(message) {
        ...
        try {
            const response = await fetch('/api/reviews/sync/push', {
                ...
                body: JSON.stringify({
                    user: RS.state.currentUser || 'anonymous',
    ...
    function updateGitSyncIndicator() {
        ...
        const currentBranch = RS.packages && RS.packages.currentBranch;
    ...
    RS.updateGitSyncIndicator = updateGitSyncIndicator;
    ...
    RS.handleGitSyncResult = handleGitSyncResult;
        ...
        return `
            <div class="git-sync-controls">
                ...
                <div class="git-sync-buttons">
                    ...
                    <button class="rs-btn rs-btn-sm rs-btn-fetch-all" onclick="ReviewSystem.fetchAllPackageUsers()" title="Fetch data from all package contributors">
                        &#x21c4; Fetch All
                    </button>
                </div>
            </div>
    ...
    RS.createGitSyncControls = createGitSyncControls;
    ...
    async function fetchAllPackageUsers() {
        ...
        try {
            ...
            if (result.contributors && result.contributors.length > 0) {
                ...
                if (RS.packages) {
                    RS.packages.contributors = result.contributors;
                }
    ...
    RS.fetchAllPackageUsers = fetchAllPackageUsers;
