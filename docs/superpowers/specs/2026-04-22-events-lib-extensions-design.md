...
- REQ-d00115 (event/provenance schema)
- REQ-d00120 (hash chain identity)
- REQ-d00133 (EntryService write API)
- REQ-d00134 (bootstrap registry)

Per CLAUDE.md §"Phase Design Spec Requirements", per-implementation `// Implements:` and per-test `// Verifies:` annotations are required on every implementation/test file this phase touches. Implementation plan: `docs/superpowers/plans/2026-04-21-mobile-event-sourcing-refactor/PLAN_PHASE4.4_library.md`.
