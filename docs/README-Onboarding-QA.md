...
**Location**: `apps/daily-dairy/clinical_diary/test/`
...
**Integration tests**: `apps/daily-dairy/clinical_diary/integration_test/`
```bash
...
**Location**: `apps/daily-dairy/clinical_diary/functions/src/__tests__/`
...
**The main test orchestrator**: `apps/daily-dairy/clinical_diary/tool/test.sh`
...
```bash
# Flutter unit tests
cd apps/daily-dairy/clinical_diary && flutter test

# Flutter with coverage
flutter test --coverage && genhtml coverage/lcov.info -o coverage/html

# TypeScript tests
cd apps/daily-dairy/clinical_diary/functions && npm test

# Database tests (requires DB connection)
cd database/tests && ./run_all_tests.sh

# Full suite
cd apps/daily-dairy/clinical_diary && ./tool/test.sh
```
