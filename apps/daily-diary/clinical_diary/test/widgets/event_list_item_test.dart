...
void main() {
  group('EventListItem', () {
    ...
    testWidgets('displays start time only (one-line format)', (tester) async {
      ...
      await tester.pumpWidget(wrapWithScaffold(EventListItem(entry: entry)));
    ...
    testWidgets('shows chevron icon when onTap is provided', (tester) async {
      ...
      await tester.pumpWidget(
        wrapWithScaffold(EventListItem(entry: entry, onTap: () {})),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('calls onTap when tapped', (tester) async {
      ...
      await tester.pumpWidget(
        wrapWithScaffold(
          EventListItem(entry: entry, onTap: () => tapped = true),
        ),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('shows warning icon when hasOverlap is true', (tester) async {
      ...
      await tester.pumpWidget(
        wrapWithScaffold(EventListItem(entry: entry, hasOverlap: true)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('does not show warning icon when hasOverlap is false', (
      ...
      await tester.pumpWidget(
        wrapWithScaffold(EventListItem(entry: entry, hasOverlap: false)),
      );
      await tester.pumpAndSettle();
    ...
    group('No Nosebleeds event card', () {
      testWidgets('displays green checkmark icon', (tester) async {
        final entry = buildNoEpistaxisEntry(entryId: 'test-1', date: testDate);
