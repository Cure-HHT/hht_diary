...
void main() {
  group('EventListItem', () {
    ...
    testWidgets('calls onTap when tapped', (tester) async {
      ...
      await tester.pumpWidget(
        wrapWithScaffold(EventListItem(view: view, onTap: () => tapped = true)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('shows warning icon when hasOverlap is true', (tester) async {
      ...
      await tester.pumpWidget(
        wrapWithScaffold(EventListItem(view: view, hasOverlap: true)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('does not show warning icon when hasOverlap is false', (
      ...
      await tester.pumpWidget(
        wrapWithScaffold(EventListItem(view: view, hasOverlap: false)),
      );
      await tester.pumpAndSettle();
