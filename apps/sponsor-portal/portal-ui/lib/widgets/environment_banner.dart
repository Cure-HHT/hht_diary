...
/// A banner overlay that displays the current environment (DEV/QA/UAT).
///
...
///
/// Unlike Flutter's `debugShowCheckedModeBanner`, this ribbon is a plain
/// `CustomPaint` widget and renders in release builds.
///
/// Usage:
/// ```dart
/// EnvironmentBanner(
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            top: 0,
            left: 0,
            child: _EnvironmentRibbon(flavor: F.appFlavor ?? Flavor.local),
          ),
        ],
      ),
    );
