      ...
      footer: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            // Figma: footer brand mark is ~100x15 next to the "Sponsored by"
            // label — much smaller than the login-card logo, so the bounds are
            // overridden here (contained within 100 x 16) rather than on the
            // shared widget.
            const SponsorBrandMark(maxHeight: 16, maxWidth: 100),
          ],
        ),
      ),
