...
Widget _kitThemed(Widget child) =>
    Theme(data: buildAppTheme(font: AppFontFamily.inter), child: child);
...
void main() {
  ...
  testWidgets('tapping an action dismisses the sheet then invokes its handler', (
    tester,
  ) async {
    var tapped = 0;
    await pumpDialog(
