...
void main() {
  group('operator-tier enforcement matrix', () {
    ...
    test('Administrator vs staff-target: allowed; vs op-target: denied', () async {
    ...
    test('dispatch: Administrator edits/deactivates staff-target -> success',
        () async {
    ...
    test('dispatch: SystemOperator grant_role of SystemOperator -> success',
        () async {
    ...
    test('dispatch: SystemOperator edits/deactivates op-target -> success',
        () async {
