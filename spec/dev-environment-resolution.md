...
A. The mobile and portal applications SHALL resolve the active environment at runtime from a bundled environment pointer rather than a compile-time constant.
