...
Validates: DIARY-PRD-user-account-create, DIARY-PRD-user-account-site-assignment, DIARY-GUI-user-management-tabs
...
Validates: DIARY-PRD-user-account-edit, DIARY-GUI-user-information-modal
...
Validates: DIARY-PRD-user-account-deactivate, DIARY-PRD-reason-field-constraints, DIARY-GUI-user-account-deactivate
...
Validates: DIARY-PRD-user-account-reactivate, DIARY-GUI-user-account-reactivate
...
Validates: DIARY-PRD-user-account-activation-resend
...
Validates: DIARY-GUI-user-management-tabs, DIARY-GUI-administrator-dashboard
