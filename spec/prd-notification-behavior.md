...
This requirement defines system-wide standards for **Push Notifications** delivered by the **Mobile Application** to the **Participant**'s device. The standards defined herein apply to all notifications generated by the **Mobile Application** and shall not be restated within individual notification requirements.
