...
A. The System SHALL generate a *Linking Code* server-side with sufficient entropy — a *Sponsor* prefix followed by eight characters drawn from a non-ambiguous character set — set a 72-hour expiry, and issue it as a `participant_linking_code_issued` event carrying the plaintext code.
...
*End* *Linking-Code Lifecycle and Uniqueness* | **Hash**: e817982d
