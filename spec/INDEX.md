...
| REQ-d00086 | dev-sponsor-repos.md | Sponsor Repository Structure Template | d867343c |
| REQ-d00087 | dev-sponsor-repos.md | Core Repo Reference Configuration | efd9e459 |
| REQ-d00088 | dev-sponsor-repos.md | Sponsor Requirement Namespace Validation | 98222b9a |
| REQ-d00089 | dev-sponsor-repos.md | Cross-Repository Traceability | c5518bd7 |
...
| REQ-o00076 | ops-sponsor-repos.md | Sponsor Repository Provisioning | adce6e73 |
| REQ-o00077 | ops-sponsor-repos.md | Sponsor CI/CD Integration | d5a5b947 |
...
| REQ-p01060 | prd-architecture-multi-sponsor.md | UX Changes During Trials | 054abe40 |
