...
- Study Coordinators can be assigned to multiple sites
- CRAs can monitor multiple sites
...
G. The Sponsor Portal SHALL display linking code to Study Coordinator after patient enrollment.

*End Linking Code Lifecycle Management* | **Hash**: ed50f68a
