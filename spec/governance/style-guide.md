...
<!-- All defined terms use **term** emphasis; external standards are
     marked with the `: Reference` sentinel keyword inside the glossary
     entry (see governance/glossary-example.md). -->
...
requirement text may then reference the acronym as `**TLA**`:
