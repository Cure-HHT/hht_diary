# modules/billing-stop-funk/outputs.tf

output "function_name" {
  description = "The deployed Cloud Function name"
  value       = google_cloudfunctions2_function.billing_stop.name
}

output "function_uri" {
  description = "The URI of the Cloud Function"
  value       = google_cloudfunctions2_function.billing_stop.service_config[0].uri
}
...
output "subscription_name" {
  ...
  value       = google_pubsub_subscription.billing_stop.name
}
